			...
			<nav class="navbar navbar-expand-lg navbar-light bg-light sticky-nav">
				...
				<div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
					<ul class="navbar-nav justify-content-center">
						<li class="nav-item">
							<a class="nav-link text-white" href="adminhome.php">Home
						...
						<li class="nav-item dropdown">
							...
							<a class="dropdown-item" href="manageemployer.php">Employers</a>
								<a class="dropdown-item" href="managecandidate.php">Candidates</a>
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="addquestions.php">Questions</a>
								
							</div> -->
						</li>
						<!-- <li class="nav-item">
							<a class="nav-link text-white" href="changepassword.php">Changepassword</a>
						</li> -->
